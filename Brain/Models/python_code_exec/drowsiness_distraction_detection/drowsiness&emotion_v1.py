...
while not stop_flag:
    ...
    skip_emotion_check = False  # Reset at each frame
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            distraction_detected = avg_pos < 0.2 or avg_pos > 1
            ...
            if YAWN_TIME >= YAWN_TIME_THRESH:
                ...
                skip_emotion_check = True
            elif pitch_angle and pitch_angle > PITCH_LOOKING_DOWN_THRESHOLD:
            ...
            # ========== Emotion Detection (Only if no alert) ==========
            frame_count += 1
