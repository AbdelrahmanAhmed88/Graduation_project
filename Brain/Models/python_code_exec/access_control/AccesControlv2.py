...
# Load models **before** opening the camera
encodings_file = r"E:/engeneering/graduation project/project/backend-nodejs/python_code_exec/python/access_control/encodings.pkl"
...
# Now open the camera (after loading models)
